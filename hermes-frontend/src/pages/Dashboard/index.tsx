...
const CRYPTO_CARDS = [
  ...
  { symbol: 'BTC', name: 'Bitcoin', price: '$25,450', change: '+ 1.25', up: true, color: '#d4a96a',
  ...
  { symbol: 'NEO', name: 'Neo', price: '$25,450', change: '+ 0.50', up: true, color: '#5699a3',
...
const LIVE_COINS = [
  { symbol: 'NEO', name: 'Neo', price: '$25,450', bg: '#5699a3' },
  ...
  { symbol: 'BTG', name: 'Bitcoin Gold', price: '$25,450', bg: '#d4a96a' },
...
const MARKET_CAP = [
  { rank: 1, symbol: 'BTC', name: 'Bitcoin', price: '$11,590.90', change: '+5.24%', up: true, bg: '#d4a96a' },
  ...
  { rank: 7, symbol: 'NEO', name: 'Neo', price: '$125.30', change: '+2.55%', up: true, bg: '#5699a3' },
      ...
      <svg width="100%" height="100%" viewBox="0 0 600 200" preserveAspectRatio="none">
        <defs>
          <linearGradient id="btcGrad" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="100%" stopColor="#d4a96a" stopOpacity={0.02} />
          </linearGradient>
        </defs>
        {[0, 50, 100, 150, 200].map(y => (
          <line key={y} x1="0" y1={y} x2="600" y2={y} stroke="#e4e7ea" strokeWidth="0.5" />
        ))}
        <path d={`${btcPath()} L600,200 L0,200 Z`} fill="url(#btcGrad)" />
        <path d={btcPath()} fill="none" stroke="#d4a96a" strokeWidth="2" ref={pathRef} />
        {hover && (
          <>
            <line x1={hover.svgX} y1="0" x2={hover.svgX} y2="200" stroke="#d4a96a" strokeWidth="0.8" strokeDasharray="4,3" opacity="0.5" />
            <line x1="0" y1={hover.svgY} x2="600" y2={hover.svgY} stroke="#aaa" strokeWidth="0.5" strokeDasharray="3,3" opacity="0.4" />
            <circle cx={hover.svgX} cy={hover.svgY} r="4" fill="#fff" stroke="#d4a96a" strokeWidth="2" />
          </>
        )}
      </svg>
      {hover && <Tooltip $x={hover.px} $y={hover.py - 8} $color="#d4a96a">{hover.val}</Tooltip>}
    </ChartArea>
  );
};
    ...
    <Page>
          ...
          <StyledTable>
            ...
            <tbody>
              {TRANSACTIONS.map((tx, i) => (
                <tr key={i}>
                  <td>{tx.date}</td>
                  <td style={{ color: tx.type === 'Buy' ? '#5699a3' : '#d4bbb5', fontWeight: 600 }}>{tx.type === 'Buy' ? t('dashboard.buy') : t('dashboard.sell')}</td>
                  <td>{tx.amount}</td>
                  <td>{tx.remaining}</td>
                  <td>{tx.price}</td>
                  <td>{tx.usd}</td>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 0', fontSize: '0.75rem', color: '#969ba0' }}>
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          <a href="#" style={{ color: '#969ba0', textDecoration: 'none' }}>{t('footer.portfolio')}</a>
          <a href="#" style={{ color: '#969ba0', textDecoration: 'none' }}>{t('footer.licenses')}</a>
