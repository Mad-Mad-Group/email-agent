...
const StatusBanner = styled.div<{ $type: 'success' | 'error' | 'loading' }>`
  ...
  background: ${({ $type, theme }) =>
    $type === 'success' ? `linear-gradient(135deg, ${theme.colors.green}1a 0%, ${theme.colors.green}26 100%)`
    : $type === 'error' ? `linear-gradient(135deg, ${theme.colors.red}1a 0%, ${theme.colors.red}26 100%)`
    : `linear-gradient(135deg, ${theme.colors.blue}1a 0%, ${theme.colors.blue}26 100%)`};
  color: ${({ $type, theme }) =>
