...
__decorate([
    (0, common_1.Get)(':id/analyses'),
    (0, permission_decorator_1.Permission)('ai.view'),
    openapi.ApiResponse({ status: 200, type: [Object] }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AiAnalysisController.prototype, "list", null);
exports.AiAnalysisController = AiAnalysisController = __decorate([
    (0, swagger_1.ApiTags)('AI 分析'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.Controller)('ai/leads'),
